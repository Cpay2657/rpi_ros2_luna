'''
This program is an edited version of 'ibus_reader.py' which reads the I-Bus protocol of the FS-IA6B.
The edits add an additional output PWM on GPIO 21, and a brief conversion of the I-Bus readings
(pulse width in usec) to Duty Cycle (%).
...
while True:
    ...
    if intReceived == 32:
        ...
        print(f"{pi.get_PWM_dutycycle(PWM_PIN)}")
